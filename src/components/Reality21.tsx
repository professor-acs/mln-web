    ...
    <div ref={chartRef} className="p-10 glass-card border-white/5 mt-20">
      <div className="flex flex-wrap items-center justify-between gap-8 mb-12">
        <div>
          ...
          <p className="text-[9px] font-mono text-slate-350 uppercase tracking-[0.3em]">
...
function StatCard({ stat, index }: { stat: typeof realityData.stats[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] font-mono text-slate-350 uppercase tracking-[0.4em] text-center md:text-left">
        {stat.label}
      </p>
    </motion.div>
  )
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className={`font-serif text-xl tracking-tight transition-all duration-500 ${
                        activeCaseStudy === i ? 'text-white translate-x-1' : 'text-slate-400 group-hover:text-slate-200'
                      }`}>
                        {c.tag}
                      </span>
                    </div>
                    ...
                    {activeCase.analysis.map((item, i) => (
                      ...
                      >
                        <div className="flex items-center gap-4 mb-6">
                          ...
                          <span className="text-[10px] font-mono text-slate-350 uppercase tracking-[0.3em] group-hover:text-accent transition-colors duration-500">
                            {item.label}
                          </span>
                        </div>
